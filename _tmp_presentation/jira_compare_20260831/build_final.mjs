...
const workspace = "C:/Users/user/Desktop/project/Auto_Reports/_tmp_presentation/jira_compare_20260831";
const starter = `${workspace}/template-starter.pptx`;
const output = "C:/Users/user/Desktop/project/Auto_Reports/Auto_Reports_JIRA_비교_시연자료.pptx";
...
starterRecords = (await fs.readFile(`${workspace}/template-starter.pptx.inspect.ndjson`, "utf8"))
  .split(/\r?\n/)
  .filter(Boolean)
