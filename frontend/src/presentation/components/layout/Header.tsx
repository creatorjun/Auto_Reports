...
export default function Header() {
  ...
  return (
    <header className="bg-white px-7 py-0 h-14 flex items-center relative">
      <div className="flex items-center gap-2 absolute left-7">
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        ...
        {triggerMessage && (
          <span className="text-[11px] text-green-700 mt-0.5">{triggerMessage}</span>
        )}
      </div>
    </header>
  )
