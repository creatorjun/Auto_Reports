// frontend/src/presentation/components/tables/ProcessingModal.tsx
...
import type { ProcessingIssue } from '@/domain/Dashboard'
...
const COLUMNS: ColumnDef<ProcessingIssue>[] = [
...
export default function ProcessingModal({ issues, total, onClose }: Props) {
  return (
    <IssueTableModal
      title="처리 중"
      subtitle={`현재 처리 진행 중인 이슈 · 전체 ${total}건 (오래된 순)`}
      data={issues}
      columns={COLUMNS}
